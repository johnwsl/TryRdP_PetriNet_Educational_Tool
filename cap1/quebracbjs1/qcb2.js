function mainquebracb(bodygraph, qxml, nextpage, ex, pontos)
{
    ...
    else
    {
        ...
        try
        {
            ...
            transwhite.setAttribute('Label','LigarRoteador');
            transwhite.setAttribute('IDqcb', 'RoteadorLigando');	
            transwhite1=graph.insertVertex(parent, null, transwhite, 300, 50, 25, 35, 'transwhite');		
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','DesligarRoteador');
            transwhite.setAttribute('IDqcb', 'RoteadorDesligando');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 250, 250, 25, 35, 'transwhite');	
            
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','RoteadorLigado');
            place.setAttribute('IDqcb', 'RoteadorLigado');
            ...
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token1', true);
            toklabel.setConnectable(false);

            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','RoteadorDesligado');
            place.setAttribute('IDqcb', 'RoteadorDesligado');
