...
///////////////////// OBSEVAÇÃO: ESTE ARQUIVO É USADO APENAS PARA QUESTÕES SOBRE MÉTRICAS E QUE O GRÁFICO É INALTERÁVEL /////////////
...
function main(bodygraph, qxml, nextpage, ex, pontos, metricamodel, showsimulacao)
{
    ...
    // metricamodel -> modelo inalterável em formato da biblioteca MxGraph que será usado na questão das métricas 
    ...
    //Observação: os atributos de qxml seguem um formato criado pelo programador, explicado no decorrer do código
        ...
        else
        {
            ...
            //graph.setCellsMovable(false);//Apenas para esse arquivo            
            ...
            //ADICIONA BOTÕES SAVE E LOAD
                ...
                toolbar.addSeparator('../src/images/transparent.gif');toolbar.addSeparator('../src/images/transparent.gif');
                toolbar.addSeparator('../src/images/transparent.gif');toolbar.addSeparator('../src/images/transparent.gif');
                toolbar.addSeparator('../src/images/transparent.gif');toolbar.addSeparator('../src/images/transparent.gif');
                toolbar.addSeparator('../src/images/transparent.gif');toolbar.addSeparator('../src/images/transparent.gif');
                toolbar.addSeparator('../src/images/transparent.gif');toolbar.addSeparator('../src/images/transparent.gif');
            ...
            document.getElementById("enviar").addEventListener("click", function(){gerador(graph, qxml, nextpage, ex, pontos,showsimulacao);});
            ...
            ////////////////// ESTABELECE O MODELO COM O metricamodel ////////////////////////////

            graph.getModel().beginUpdate();
            try
            {
                var req = mxUtils.load(metricamodel);
    ...
    function gerador(graph, qxml, nextpage, ex, pontos,showsimulacao)
    {				
        var encoder = new mxCodec();
        var node = encoder.encode(graph.getModel());			
        var text = mxUtils.getXml(node);		
    ...
    function comparador(textxml, MetricaArr, TransImArr, qxml, numLugar, numTransIm, numTransTemp, numMetrica, numArcoInibidor, numArco)
    {
        ...
        if(numTransTemp==l)
        {
            ...
            if(count!=l){mxUtils.alert("Modelagem incorreta. Observação: as propriedades ou conexões de algumas transições temporizada estão incorretas."); return null;};
            count = 0;
        }
