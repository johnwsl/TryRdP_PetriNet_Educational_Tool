function mainquebracb(bodygraph, qxml, nextpage, ex, pontos)
{
    ...
    else
    {
        ...
        try
        {
            ...
            transwhite.setAttribute('Label','Entrada');
            ...
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','MensagemAlerta');
            transwhite.setAttribute('IDqcb', 'malerta');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 480, 380, 25, 35, 'transwhite');
            
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','Memória');
            place.setAttribute('IDqcb', 'memoria');
            plc = graph.insertVertex(parent, null, place,350 ,250 , 35, 35, 'place');
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','LimiteMemória');
            place.setAttribute('IDqcb', 'limite');
            plc = graph.insertVertex(parent, null, place,100 ,300 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','1000');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            ...
            var arco = docxml.createElement('Arco');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 150, 100, 0, 0);
            pt = docxml.createElement('Ponto');
            ...
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 400, 100, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearcoinibidor'); 
        }
        finally
        {
            graph.getModel().endUpdate();
