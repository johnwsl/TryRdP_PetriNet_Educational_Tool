function mainquebracb(bodygraph, qxml, nextpage, ex, pontos)
{
    ...
    else
    {
        ...
        try
        {
            ...
            transwhite.setAttribute('Label','ChegadaBrinquedo');
            transwhite.setAttribute('IDqcb', 'ChegadaBrinquedo');	
            transwhite1=graph.insertVertex(parent, null, transwhite, 350, 150, 25, 35, 'transwhite');		
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','ChegadaEmbalagem');
            transwhite.setAttribute('IDqcb', 'ChegadaEmbalagem');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 250, 250, 25, 35, 'transwhite');	
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','MáquinaEmbalarBrinquedo');
            transwhite.setAttribute('IDqcb', 'EmbalarBrinquedo');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 100, 350, 25, 35, 'transwhite');	
            
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','Brinquedos');
            place.setAttribute('IDqcb', 'Brinquedos');
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','Embalagens');
            place.setAttribute('IDqcb', 'Embalagem');
