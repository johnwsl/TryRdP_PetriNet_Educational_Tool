function mainquebracb(bodygraph, qxml, nextpage, ex, pontos)
{
    ...
    else
    {
        ...
        try
        {
            ...
            place.setAttribute('Label','MemóriaOctal');
            place.setAttribute('IDqcb', 'memoriaoctal');
            plc = graph.insertVertex(parent, null, place,70 ,510 , 35, 35, 'place');
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','MemóriaHexa');
            place.setAttribute('IDqcb', 'memoriahexa');
            plc = graph.insertVertex(parent, null, place,170 ,400 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','HexaBits');
            place.setAttribute('IDqcb', 'hexabits');
            plc = graph.insertVertex(parent, null, place,70 ,440 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','OctalBits');
            place.setAttribute('IDqcb', 'octalbits');
            plc = graph.insertVertex(parent, null, place,70,370 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','Caractere');
            place.setAttribute('IDqcb', 'caracteres');
            plc = graph.insertVertex(parent, null, place,70, 300, 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            ...
            transwhite.setAttribute('Label','SaídaInformaçãoHexa');
            transwhite.setAttribute('IDqcb', 'saidahexa');	
            transwhite1=graph.insertVertex(parent, null, transwhite, 300, 520, 25, 35, 'transwhite');		
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','SaídaInformaçãoOctal');
            transwhite.setAttribute('IDqcb', 'saidaoctal');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 300, 450, 25, 35, 'transwhite');	

            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','ArmazenarDoisBytes');
            transwhite.setAttribute('IDqcb', 'ardoisbytes');	
            transwhite1=graph.insertVertex(parent, null, transwhite, 300, 380, 25, 35, 'transwhite');		
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','ArmazenarByte');
            transwhite.setAttribute('IDqcb', 'arbyte');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 300, 310, 25, 35, 'transwhite');		

            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','RepresentarHexa');
            transwhite.setAttribute('IDqcb', 'rehexa');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 300, 240, 25, 35, 'transwhite');
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','RepresentarOctal');
            transwhite.setAttribute('IDqcb', 'reoctal');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 300, 170, 25, 35, 'transwhite');
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','EntradaDadoCaractere');
            transwhite.setAttribute('IDqcb', 'entrada');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 300, 100, 25, 35, 'transwhite');
            
            var arco = docxml.createElement('Arco');
            arco.setAttribute('Peso', '2');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 220, 50, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 170, 50, 0, 0);	
            ...
            arco.setAttribute('Peso', '2');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 220, 100, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 170, 100, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');

            var arco = docxml.createElement('Arco');
            arco.setAttribute('Peso', '8');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 220, 150, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 170, 150, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');

            var arco = docxml.createElement('Arco');
            arco.setAttribute('Peso', '8');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 220, 200, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 170, 200, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');

            var arco = docxml.createElement('Arco');
            arco.setAttribute('Peso', '16');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 220, 250, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 170, 250, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');

            var arco = docxml.createElement('Arco');
            arco.setAttribute('Peso', '16');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 320, 50, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 270, 50, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');

            var arco = docxml.createElement('Arco');
            var pt = docxml.createElement('Ponto');
            var pt1 = graph.insertVertex(parent, null, pt, 100, 250, 0, 0,);
            pt = docxml.createElement('Ponto');
            var pt2 = graph.insertVertex(parent, null, pt, 50, 250, 0, 0,);
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');
            
            var arco = docxml.createElement('Arco');
            var pt = docxml.createElement('Ponto');
            var pt1 = graph.insertVertex(parent, null, pt, 100, 200, 0, 0,);
            pt = docxml.createElement('Ponto');
            var pt2 = graph.insertVertex(parent, null, pt, 50, 200, 0, 0,);
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');
            
            var arco = docxml.createElement('Arco');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 100, 100, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 50, 100, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');
            
            var arco = docxml.createElement('Arco');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 100, 50, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 50, 50, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');

            var arco = docxml.createElement('Arco');
            var pt = docxml.createElement('Ponto');
            var pt1 = graph.insertVertex(parent, null, pt, 100, 150, 0, 0,);
            pt = docxml.createElement('Ponto');
            var pt2 = graph.insertVertex(parent, null, pt, 50, 150, 0, 0,);
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');
        }
        finally
        {
