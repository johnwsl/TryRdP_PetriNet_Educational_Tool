function mainquebracb(bodygraph, qxml, nextpage, ex, pontos)
{
    ...
    else
    {
        ...
        try
        {
            ...
            transwhite.setAttribute('Label','GenChuikov');
            transwhite.setAttribute('IDqcb', 'GenChuikov');	
            transwhite1=graph.insertVertex(parent, null, transwhite, 300, 200, 25, 35, 'transwhite');		
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','EnvioInfo');
            transwhite.setAttribute('IDqcb', 'EnvioInfo');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 250, 250, 25, 35, 'transwhite');	
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','Missão1');
            transwhite.setAttribute('IDqcb', 'Mis1');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 50, 350, 25, 35, 'transwhite');	
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','Missão2');
            transwhite.setAttribute('IDqcb', 'Mis2');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 170, 150, 25, 35, 'transwhite');
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','Missão3');
            transwhite.setAttribute('IDqcb', 'Mis3');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 420, 380, 25, 35, 'transwhite');
            
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','InformaçãoDoGeneral');
            place.setAttribute('IDqcb', 'InfoDoGeneral');
            plc = graph.insertVertex(parent, null, place,300 ,500 , 35, 35, 'place');
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','Batalhão1');
            place.setAttribute('IDqcb', 'Bat1');
            plc = graph.insertVertex(parent, null, place,200 ,500 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','Batalhão2');
            place.setAttribute('IDqcb', 'Bat2');
            plc = graph.insertVertex(parent, null, place,450 ,200 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','Batalhão3');
            place.setAttribute('IDqcb', 'Bat3');
            plc = graph.insertVertex(parent, null, place,500 ,100 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            ...
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 350, 450, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');

            var arco = docxml.createElement('Arco');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 500, 350, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 400, 350, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');

            var arco = docxml.createElement('Arco');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 100, 250, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 250, 350, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');
            
            var arco = docxml.createElement('Arco');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 600, 450, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 550, 350, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');
            
            var arco = docxml.createElement('Arco');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 600, 550, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 450, 550, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');
            ...
            var arco = docxml.createElement('Arco');
            pt = docxml.createElement('Ponto');
            pt1 = graph.insertVertex(parent, null, pt, 200, 50, 0, 0);
            pt = docxml.createElement('Ponto');
            pt2 = graph.insertVertex(parent, null, pt, 400, 50, 0, 0);	
            graph.insertEdge(parent, null, arco, pt1, pt2, 'stylearco');
