function mainquebracb(bodygraph, qxml, nextpage, ex, pontos)
{
    ...
    else
    {
        ...
        try
        {
            ...
            transwhite.setAttribute('Label','SaídaParaLoja');
            transwhite.setAttribute('IDqcb', 'Saida');	
            transwhite1=graph.insertVertex(parent, null, transwhite, 350, 150, 25, 35, 'transwhite');		
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','VendaProduto');
            transwhite.setAttribute('IDqcb', 'VendaProduto');	
            ...
            transwhite2=graph.insertVertex(parent, null, transwhite, 480, 380, 25, 35, 'transwhite');
            
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','EstoqueExterno');
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','EstoqueLoja');
            place.setAttribute('IDqcb', 'Loja');
            ...
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','LimiteEstoqueExterno');
            place.setAttribute('IDqcb', 'LimiteEstoque');
            plc = graph.insertVertex(parent, null, place,450 ,200 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','100');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
            
            var place = docxml.createElement('Lugar');
            place.setAttribute('Label','LimiteLoja');
            place.setAttribute('IDqcb', 'LimiteLoja');
            plc = graph.insertVertex(parent, null, place,500 ,100 , 35, 35, 'place');
             var tokl = docxml.createElement('TokenLabel');//objeto colocados 'dentro' da célula lugar para representar os tokens
            tokl.setAttribute('Label','30');
            toklabel = graph.insertVertex(plc, null, tokl, 0.3, 0.3, 15, 15, 'token', true);
            toklabel.setConnectable(false);
