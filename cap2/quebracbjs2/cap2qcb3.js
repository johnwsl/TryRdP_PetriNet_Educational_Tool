function mainquebracb(bodygraph, qxml, nextpage, ex, pontos)
{
    ...
    else
    {
        ...
        try
        {
            ...
            transwhite.setAttribute('Label','Processo1');
            transwhite.setAttribute('IDqcb', 'Processo1');	
            transwhite1=graph.insertVertex(parent, null, transwhite, 350, 150, 25, 35, 'transwhite');		
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','Processo2');
            transwhite.setAttribute('IDqcb', 'Processo2');	
            transwhite2=graph.insertVertex(parent, null, transwhite, 250, 250, 25, 35, 'transwhite');	
            
            var transwhite = docxml.createElement('TransTemp');
            transwhite.setAttribute('Label','Processo3');
            transwhite.setAttribute('IDqcb', 'Processo3');	
            ...
            place.setAttribute('Label','MateriaPrima');
            place.setAttribute('IDqcb', 'materiaprima');
